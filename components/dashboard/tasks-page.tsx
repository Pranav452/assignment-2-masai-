    ...
    <div className="h-full overflow-y-auto">
      <div className="p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8">
            ...
            <CardContent className="p-4 sm:p-6 lg:p-8">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl sm:rounded-3xl flex items-center justify-center shadow-lg">
                    <CheckSquare className="h-6 w-6 sm:h-8 sm:w-8 text-white" />
                  </div>
                  <div>
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-slate-900 to-purple-900 bg-clip-text text-transparent">
                      Your Tasks
                    </h1>
                    <p className="text-base sm:text-lg lg:text-xl text-slate-600 mt-1 sm:mt-2">Manage and organize your tasks efficiently</p>
                  </div>
                </div>
                <div className="text-center sm:text-right">
                  <div className="text-2xl sm:text-3xl font-bold text-purple-700">{tasks.length}</div>
        ...
        >
            ...
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl sm:text-3xl font-bold text-blue-900">{pendingTasks}</p>
                </div>
            ...
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl sm:text-3xl font-bold text-green-900">{completedTasks}</p>
                </div>
          ...
          <Card className="bg-gradient-to-br from-red-50 to-rose-50 border-red-200/50 sm:col-span-2 lg:col-span-1">
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-red-700">High Priority</p>
                  <p className="text-2xl sm:text-3xl font-bold text-red-900">{highPriorityTasks}</p>
                </div>
        ...
        >
          <Card className="bg-white/80 backdrop-blur-sm border-slate-200/50 shadow-xl">
            <CardHeader className="pb-4">
              <CardTitle className="text-lg sm:text-xl font-bold flex items-center gap-2 sm:gap-3 text-slate-900">
                <Filter className="h-4 w-4 sm:h-5 sm:w-5 text-slate-700" />
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                  ...
                  <div className="flex items-center gap-2 sm:ml-auto">
                    ...
                    >
                      ...
                      <span className="ml-2 sm:hidden">Cards</span>
                    </Button>
                    <Button
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-slate-200/50 shadow-xl">
            ...
            <CardContent>
              {filteredTasks.length === 0 ? (
                <div className="text-center py-12 sm:py-16">
                  <div className="text-slate-400 mb-4">
                    <CheckSquare className="h-12 w-12 sm:h-16 sm:w-16 mx-auto" />
                  </div>
                  <h3 className="text-lg sm:text-xl font-semibold text-slate-700 mb-2">No tasks found</h3>
              ...
              {hasMoreTasks && !showAll && (
                <div className="flex justify-center mt-6 sm:mt-8 pt-6 border-t border-slate-200">
                  <Button
                    onClick={() => setShowAll(true)}
                    variant="outline"
                    className="w-full sm:w-auto bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200 hover:from-blue-100 hover:to-indigo-100 text-blue-700 hover:text-blue-800"
                  >
              ...
              {showAll && hasMoreTasks && (
                <div className="flex justify-center mt-6 sm:mt-8 pt-6 border-t border-slate-200">
                  <Button
                    ...
                    variant="outline"
                    className="w-full sm:w-auto bg-gradient-to-r from-slate-50 to-gray-50 border-slate-200 hover:from-slate-100 hover:to-gray-100 text-slate-700 hover:text-slate-800"
                  >
                    Show Less
                  </Button>
                </div>
